        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center mb-6">
          ...
          >
            <div className="w-full h-0 pb-[56.25%] relative">
              {/* SEO here: YouTube embed with proper title and loading */}
              <iframe
          ...
          <div data-aos="fade-right">
            {/* SEO here: H2 heading for about section */}
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-8">
              {t('aboutTitle')}
            </h2>
            {/* SEO here: Rich content with keywords - Render description with preserved newlines */}
