...
const IntlTourCard = forwardRef<HTMLDivElement, TourCardProps>(({ tour, currentPage }, ref) => { 
  ...
  return (
    <div
      ...
      data-aos="fade-up"
    >
      <Link to={`/international-tours/${tour.slug}`} onClick={handleCardClick}>
